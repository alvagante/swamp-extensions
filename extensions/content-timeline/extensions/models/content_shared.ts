...
export const PERSONA_DIRECTIVES: Record<Persona, string> = {
  ...
  confessional:
    "Voice: Confessional. Raw, intimate, emotionally unguarded. The narrator volunteers what others would keep private — doubts, failures, shameful enthusiasms, the gap between who they were and who they wanted to be. Frank O'Hara's casual honesty, Sylvia Plath's precision about pain, Joan Didion's cold eye on the self. Not melodrama: the emotion earns its place by being specific and true. The confession is the argument.",
  obituary:
    "Voice: Elegiac obituary. Measured, retrospective, written from a slight distance — the kind of distance that comes from having survived the person being described. Weighs what endured against what was lost. Quiet authority, no sentimentality, the occasional dry flash of recognition. Reads as if written by someone who loved the subject enough to be exact about their flaws.",
  myth:
...
export const CARD_STYLE_PREFIXES: Record<CardStyle, string> = {
  ...
  "iam-portrait":
    "Biographical portrait card. Layout: a small circular portrait thumbnail at the top center (pencil-bw or editorial style, white background), the subject's name or facet title in a clean serif below it, then the main facet image occupying the lower two-thirds of the card. Card border is a fine ruled frame in warm gray. Typography uses a mix of serif (name) and small-caps sans-serif (descriptor label). Palette: warm off-white card stock (#faf8f4), near-black ink, a single warm brown accent (#8b5e3c) for the name and border rule. No suit marks, no game numerals — this is a biographical record card, not a playing card. Feels like a cabinet card from a scholarly archive. ",
};
