...
- `.kiro/skills/swamp/SKILL.md` - Swamp CLI — models, workflows, data, vaults, extensions, publishing, repos, reports, issues, and troubleshooting
...
If models already exist, start by reading `.kiro/skills/swamp/SKILL.md`
