...
8. **Reports for reusable data pipelines.** When the task involves building a repeatable pipeline to transform, aggregate, or analyze model output (security reports, cost analysis, compliance checks, summaries), create a report extension. Read `.kiro/skills/swamp-report/SKILL.md` for guidance.

## Skills

**IMPORTANT:** Skills are detailed guides stored in `.kiro/skills/`. When a task
matches a skill area below, read the corresponding `SKILL.md` file for guidance.

- `.kiro/skills/swamp-getting-started/SKILL.md` - Interactive onboarding for new swamp users
- `.kiro/skills/swamp-model/SKILL.md` - Work with swamp models (creating, editing, validating)
- `.kiro/skills/swamp-workflow/SKILL.md` - Work with workflows (creating, editing, running)
- `.kiro/skills/swamp-vault/SKILL.md` - Manage secrets and credentials
- `.kiro/skills/swamp-data/SKILL.md` - Manage model data lifecycle and query with CEL
- `.kiro/skills/swamp-report/SKILL.md` - Run and configure reports for models and workflows
- `.kiro/skills/swamp-repo/SKILL.md` - Repository management
- `.kiro/skills/swamp-extension/SKILL.md` - Create custom extensions (models, vaults, drivers, datastores, reports)
- `.kiro/skills/swamp-extension-publish/SKILL.md` - Publish extensions to the registry
- `.kiro/skills/swamp-issue/SKILL.md` - Submit bug reports and feature requests
- `.kiro/skills/swamp-troubleshooting/SKILL.md` - Diagnose swamp problems and verify swamp's health

## Getting Started

**IMPORTANT:** At the start of every conversation, run
`swamp model search --json`. If no models are returned (empty result), you MUST
immediately read `.kiro/skills/swamp-getting-started/SKILL.md` and follow its
instructions. This walks new users through an interactive onboarding tutorial.

If models already exist, start by reading `.kiro/skills/swamp-model/SKILL.md`
